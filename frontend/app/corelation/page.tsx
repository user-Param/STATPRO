    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <span className="text-sm text-zinc-400  px-3 py-1 rounded-full border border-zinc-700">Funding: 0.01%</span>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <input type="text" readOnly value="10x" className="w-full  border border-zinc-700 rounded px-2 py-1 text-sm" />
              </div>
            </div>
            <div className="space-y-1">
              <label className="text-xs text-zinc-500 uppercase">Amount</label>
              <input type="text" placeholder="0.00" className="w-full  border border-zinc-700 rounded px-2 py-1 text-sm" />
            </div>
