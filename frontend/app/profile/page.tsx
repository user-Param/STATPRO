  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex items-center gap-6">
        <div className="w-20 h-20 bg-zinc-700 rounded-full flex items-center justify-center text-2xl">👤</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-2 hover:bg-zinc-800 rounded-md transition-colors cursor-pointer">
